...
public interface InfrastructureApi
{
    ...
    /**
     * List all the Network Service types defined into a datacenter.
     * 
     * @param datacenter The datacenter.
     ...
     * 
     * @param datacenter the datacenter where the network service type will belong to
     * @param nst {@link NetworkServiceTypeDto} instance to create
     * @return the created {@link NetworkServiceTypeDto}
     */
    NetworkServiceTypeDto createNetworkServiceType(DatacenterDto datacenter,
        NetworkServiceTypeDto nst);

    /**
     * Get a single instance of a {@link NetworkServiceTypeDto}
     * 
     * @param datacenter datacenter where search into
     * @param nstId identifier of the {@link NetworkServiceTypeDto}
     ...
     * 
     * @param nstDto the instance to update with the new values.
     ...
     * 
     * @param nstDto the entity to delete
     */
