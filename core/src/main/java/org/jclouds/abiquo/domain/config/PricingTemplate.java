...
/**
 * Adds high level functionality to {@link PricingTemplateDto}.
 * 
 * @author Ignasi Barrera
 * @author Susana Acedo
 * @see API: <a href="http://community.abiquo.com/display/ABI20/PricingTemplate+Resource">
 *      http://community.abiquo.com/display/ABI20/PricingTemplate+Resource</a>
 */
...
public class PricingTemplate extends DomainWrapper<PricingTemplateDto>
{
    ...
    /**
     * @see API: <a href=
     *      "http://community.abiquo.com/display/ABI20/PricingTemplate+Resource#PricingTemplateResource-Deleteapricingtemplate"
     *      > http://community.abiquo.com/display/ABI20/PricingTemplate+Resource#
     *      PricingTemplateResource- Deleteapricingtemplate </a>
     */
    public void delete()
    {
    ...
    /**
     * @see API: <a href=
     *      "http://community.abiquo.com/display/ABI20/PricingTemplate+Resource#CPricingTemplateResource-Createapricingtemplate"
     *      > http://community.abiquo.com/display/ABI20/PricingTemplate+Resource#
     *      PricingTemplateResource- Createapricingtemplate</a>
     */
    public void save()
    {
    ...
    /**
     * @see API: <a href=
     *      "http://community.abiquo.com/display/ABI20/PricingTemplate+Resource#PricingTemplateResource-Updateanexistingpricingtemplate"
     *      > http://community.abiquo.com/display/ABI20/PricingTemplate+Resource#
     *      PricingTemplateResource- Updateanexistingpricingtemplate</a>
     */
    public void update()
    {
