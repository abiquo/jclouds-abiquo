...
{
    public static Predicate<License> customerId(final String code)
    {
        return customerIds(checkNotNull(code, "Id must be defined"));
    }

    public static Predicate<License> customerIds(final String... codes)
    {
