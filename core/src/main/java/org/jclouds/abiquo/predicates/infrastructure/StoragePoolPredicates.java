...
{
    public static Predicate<StoragePool> storagePoolName(final String name)
    {
        return storagePoolNames(checkNotNull(name, "name must be defined"));
    }

    public static Predicate<StoragePool> storagePoolNames(final String... names)
    {
