...
{
    public static Predicate<Enterprise> enterpriseName(final String name)
    {
        return enterpriseNames(checkNotNull(name, "name must be defined"));
    }

    public static Predicate<Enterprise> enterpriseNames(final String... names)
    {
