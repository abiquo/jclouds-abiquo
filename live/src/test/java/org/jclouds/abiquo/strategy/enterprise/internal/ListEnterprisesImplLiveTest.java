 ...
 */
@Test(groups = "live")
public class ListEnterprisesImplLiveTest extends BaseAbiquoStrategyLiveTest<CloudTestEnvironment>
{
    ...
    {
        this.strategy = context.getUtils().getInjector().getInstance(ListEnterprisesImpl.class);
    }
